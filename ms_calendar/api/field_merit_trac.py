...
#         _applicant_name = frappe.db.get_value(
#             _frf_doctype, candidate_id, "full_name_aadhaar"
#         ) or ""
...
#             },
#             fields=["name", "applicant_id", "applicant_email",
#                     "applicant_name", "start_time", "end_time", "test_url"]
#         )
...
#         else "Field Registration Form"
#     )
#     _applicant_name = frappe.db.get_value(_frf_doctype, candidate_id, "full_name_aadhaar") or "Test"
...
#         subject = f"Admit Card – Written Test for School Teacher / Resource Person Position"
...
# @frappe.whitelist()
# def save_field_merittrac_tickets(tickets, start_datetime, end_datetime,
#                                   applicant_ids=None, test_date=None):
#     """
...
#     except Exception as e:
#         frappe.log_error(f"Creation log insert failed: {e}",
#                          "FIELD_MERITTRAC_LOG_ERROR")
